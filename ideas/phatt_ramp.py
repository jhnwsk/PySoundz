...
for time in range(1, duration_in_samples):	# Do the magic!
	osc_1 = ramp((1.0 * time * fundamental_harmonic) / samplerate) # Generate stable square wave
	osc_2 = ramp((1.0 * time * (fundamental_harmonic + subtle_lfo(time / duration_in_samples))) / samplerate) # Generate stable square wave
